                                    ...
                                    <div class="slimscroll noti-scroll">
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item notify-item active">
                                            <div class="notify-icon">
                                                <img src="<?php echo base_url(); ?>application/assets/assets/images/users/avatar-2.jpg" class="img-fluid rounded-circle" alt="" /> </div>
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            <div class="notify-icon">
                                                <img src="<?php echo base_url(); ?>application/assets/assets/images/users/avatar-4.jpg" class="img-fluid rounded-circle" alt="" /> </div>
